<template>
        ...
        <el-table border :data="list" style="width: 100%" highlight-current-row>
            <el-table-column type="index" label="#"></el-table-column> <!-- 序号 -->
                ...
                <template slot-scope="{row}">
                    {{  row.liuyanneirong  }}                </template>
            </el-table-column>
                        <el-table-column label="留言人"width="80">
                <template slot-scope="{row}">
                    {{  row.liuyanren  }}                </template>
            </el-table-column>
                        <el-table-column label="回复内容">
                <template slot-scope="{row}">
                    {{  row.huifuneirong  }}                </template>
            </el-table-column>
            ...
            <el-table-column label="操作">
                <template slot-scope="{row}">
                    ...
                    <el-button icon="el-icon-edit" @click="$goto({path:'/admin/liuyanbanupdt',query:{id:row.id } })"
