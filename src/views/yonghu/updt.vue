    ...
    <div class="yonghu-add" v-loading="loading">
        <el-card class="box-card">
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                <el-form-item label="用户名" prop="yonghuming" required :rules="[{required:true, message:'请填写用户名'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'update', module:'yonghu', col:'yonghuming', id:'{{   form.id   }}', trigger:'blur'}]">
                                            <el-input placeholder="输入用户名" style="width:250px;" v-model="form.yonghuming" />                                    </el-form-item>
