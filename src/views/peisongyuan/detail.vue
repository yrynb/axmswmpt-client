<template>
    ...
    <div class="peisongyuan-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
                ...
                <div class="detail-content">
                    <e-img :src="map.zhaopian" style="max-width:120px" />
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail(){
                ...
                this.loading = true;
                this.$get(api.peisongyuan.detail , {
                    id:this.id
                }).then(res=>{
                    this.loading = false;
