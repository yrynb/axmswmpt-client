        ...
        <el-card class="box-card">
                ...
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="状态">
                        ...
                        <el-select v-model="search.zhuangtai">
                            ...
                            <el-option label="体温正常" value="体温正常"></el-option>
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="照片" width="100">
                    <template slot-scope="{row}">
                        <e-img :src="row.zhaopian" style="max-width:120px"/>
                    </template>
                </el-table-column>
...
{{ row.addtime.substr(0,16) }}
                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-button @click="$goto('/admin/tiwenjianceadd?id='+row.id)" type="success"
                                       icon="el-icon-plus" size="mini">
                                体温检测
                            </el-button>

                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/peisongyuandetail',query:{id:row.id } })"
                                           icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/peisongyuanupdt',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.peisongyuan.list, filter).then(res => {
                    this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm('确定删除数据？', '提示', { // 弹出 确认框提示是否要删除
                    ...
                    this.$post(api.peisongyuan.delete, {// 提交后台
                        id: row.id
                    }).then(res => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
