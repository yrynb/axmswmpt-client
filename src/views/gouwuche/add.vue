        ...
        <el-card class="box-card">
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                ...
                                <el-form-item v-if="isRead" label="分类" prop="fenlei">
                                             <e-select-view module="shangpinfenlei" :value="form.fenlei" select="id" show="fenleimingcheng"></e-select-view>                                    </el-form-item>
                                ...
                                <el-form-item label="购买数量" prop="goumaishuliang" required :rules="[{required:true, message:'请填写购买数量'}, {validator:rule.checkNumber, message:'输入一个有效数字'}]">
        ...
        methods: {
            submit(){
                this.$refs.formModel.validate().then(res=>{
                    ...
                    this.$post(api.gouwuche.insert , form).then(res=>{
                        this.loading = false;
