                ...
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="分类">
                        ...
                        <el-select v-model="search.fenlei">
                            ...
                            <el-option v-for="m in shangpinfenleiList" :value="m.id"
...
{{ row.addtime.substr(0,16) }}
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/gouwuchedetail',query:{id:row.id } })"
                                           icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/gouwucheupdt',query:{id:row.id } })"
            ...
            <div>
                小计总和: {{ total.sum_xiaoji }}    <el-button type="danger" @click="$goto('/admin/dingdanxinxiadd?sum_xiaoji='+total.sum_xiaoji)">生成订单</el-button>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.gouwuche.listgoumairen, filter).then(res => {
                    this.loading = false;
