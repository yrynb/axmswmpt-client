                ...
                <td>
                            ...
                            <a href="javascript:;" @click="selectRadio('fenlei','')"
                               :class="{active:!search.fenlei}">全部</a>
                                   ...
                                   @click="selectRadio('fenlei',r.id)" :class="{active:search.fenlei == r.id}" v-text="r.fenleimingcheng">
        ...
        <el-col :md="6" v-for="r in list">
            <div class="floor_goods_wrap_li">
                <div class="floor_goods_wrap_b">
                    ...
                    <router-link :to="{path:'/shangpinxinxidetail',query:{id:r.id}}" class="floor_goods_tit" v-html="$substr(r.shangpinmingcheng,20)"></router-link>
                    <router-link :to="{path:'/shangpinxinxidetail',query:{id:r.id}}" class="floor_goods_txt" v-html="$substr(r.shangpinxiangqing,20)"></router-link>
                                        <router-link :to="{path:'/shangpinxinxidetail',query:{id:r.id}}" class="floor_goods_price">
                        ￥{{ r.jiage }}元
                    </router-link>
                                    </div>
            </div>
