                ...
                <el-table-column label="是否支付" width="120">
                    <template slot-scope="{row}">
                        ...
                        <el-button size="mini" type="primary"
                                   @click="$goto({path:'/admin/pay' , query:{biao:'dingdanxinxi' , id:row.id,ordersn:row.dingdanbianhao,zongji:row.dingdanjine } })"
                                   v-if="row.iszf=='否'">
                            去支付
                        </el-button>
                    </template>
                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-button @click="$goto('/admin/dingdanqianshouadd?id='+row.id)" type="success" v-if="row.dingdanzhuangtai == '已发货'"
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.dingdanxinxi.listxiadanren, filter).then(res => {
                    this.loading = false;
