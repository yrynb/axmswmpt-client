            ...
            <e-container>
                <div class="nav-list clearfix">
                    <ul class="clearfix">
                      ...
                      <li :class="{active:$route.path == '/'}">
                        <router-link to="/shujugailan">数据概览
                        </router-link>
                      </li>
                        <li :class="{active:$route.path == '/shangpinxinxi'}">
                            <router-link to="/shangpinxinxi">商品
                                <i class="el-icon-arrow-down"></i>
                            </router-link>
                            <ul class="nav-child">
                                <li v-for="m in listMenushangpinfenlei">
                                    <router-link :to="'/shangpinxinxi?fenlei='+m.id"
                                                 v-text="m.fenleimingcheng"></router-link>
                                </li>
                            </ul>
                        </li>
                      <li :class="{active:$route.path == '/'}">
                        <router-link to="/mingcaiyouzhu">名菜有主
                        </router-link>
                      </li>
                        <li :class="{active:$route.path == '/xinwenxinxi'}">
                            <router-link to="/xinwenxinxi">新闻
                                <i class="el-icon-arrow-down"></i>
                            </router-link>
                            <ul class="nav-child">
                                <li v-for="m in listMenuxinwenfenlei">
                                    <router-link :to="'/xinwenxinxi?fenlei='+m.id"
                                                 v-text="m.fenleimingcheng"></router-link>
                                </li>
                            </ul>
                        </li>
                        <li :class="{active:$route.path == '/liuyanbanadd'}">
                            <router-link to="/liuyanbanadd">反馈
                            </router-link>
                        </li>
