<template>
    ...
    <div class="dingdanquxiao-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            </div>                        <div class="detail detail-selectupdate">
                <div class="detail-title">
                    安排配送：
                </div>
                <div class="detail-content">
                    <p>工号：{{ map.gonghao }}</p><p>姓名：{{ map.xingming }}</p><p>配送员体温：{{ map.peisongyuantiwen }}</p>
                </div>
                ...
                <div class="detail-content">
                    <e-img :src="map.waimaitupian" style="max-width:120px" />
                </div>
            </div><div class="detail detail-image">
                <div class="detail-title">
                    配送照片：
                ...
                <div class="detail-content">
                    <e-img :src="map.peisongzhaopian" style="max-width:120px" />
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail(){
                ...
                this.loading = true;
                this.$get(api.dingdanquxiao.detail , {
                    id:this.id
                }).then(res=>{
                    this.loading = false;
